		...
		if($url[2] == "overzicht") {
			...
			echo "<table class='data'>
				...
				echo "<tr class='row" . $i . "'>
						<td>".$row['vraag']."</td>
						<td>".$row['antwoord']."</td>
						<td><a href='" . $root . "admin/faq/aanpassen/".$row['faq_id']."'>Wijzigen</a> / <a href='" . $root . "admin/faq/verwijder/" . $row['faq_id']."' onclick=\"return confirm('Weet je zeker dat dit nieuwsbericht verwijderd moet worden?');\">Verwijderen</a>
						</td>
					</tr>";
			}
			echo "</table>";
